(function () {
    ...
    function fetchProductoById(productoId) {
      return ProductoModel.findById(productoId).exec();
    }
  
    function updateProducto(productoId, producto) {
      return ProductoModel.findByIdAndUpdate(productoId, producto, {
        new: true,
      }).exec();
    }
  
    function deleteProducto(productoId) {
      return ProductoModel.findByIdAndRemove(productoId).exec();
    }
  })();
